<?php
    ...
    $theme            = 'default';
    $connectionString = 'mysql:host=localhost;port=3306;dbname=db_minimart'; // Not Coding Standard
    $username         = 'minimart';
    $password         = 'minimart';
    ...
    $instanceConfig['components']['request']['scriptUrl']         = '/minimart/app/index.php';
