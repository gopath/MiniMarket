...
import ac.id.itb.d4.minimart.employee.adapter.ProductListAdapter;
import ac.id.itb.d4.minimart.employee.connection.AsynConnection;
import ac.id.itb.d4.minimart.employee.connection.AsynConnection.RequestType;
import ac.id.itb.d4.minimart.employee.connection.ConnectionInterface;
import ac.id.itb.d4.minimart.employee.connection.Helper;
import ac.id.itb.d4.minimart.employee.connection.LoadMoreDataTask;
import ac.id.itb.d4.minimart.employee.connection.PullAndLoadInterface;
import ac.id.itb.d4.minimart.employee.connection.PullToRefreshDataTask;
import ac.id.itb.d4.minimart.employee.model.Product;
import ac.id.itb.d4.minimart.employee.parser.ProductParser;
import ac.id.itb.d4.minimart.employee.utils.AppConstant;
import ac.id.itb.d4.minimart.employee.utils.Singleton;
import ac.id.itb.d4.minimart.employee.utils.TransparentProgressDialog;
...
public class ProductActivity extends SherlockListActivity 
	implements ConnectionInterface, PullAndLoadInterface {

	private ProductActivity self = this;
		...
		self.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				case 1:
			        ...
			        Vector<Product> vectorProduct = new Vector<Product>();
			        ProductParser productParser = new ProductParser();
			        vectorProduct = productParser.parseData(value.toString());

			        ProductListAdapter adapter = new ProductListAdapter(self, vectorProduct);
