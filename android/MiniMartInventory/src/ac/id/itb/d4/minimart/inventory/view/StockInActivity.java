...
import ac.id.itb.d4.minimart.inventory.adapter.ProductListAdapter;
...
import ac.id.itb.d4.minimart.inventory.parser.StockOutParser;
...
public class StockInActivity extends SherlockListActivity 
	implements ConnectionInterface, PullAndLoadInterface {

	private StockInActivity self = this;
		...
		self.runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				case 1:
			        ...
			        Vector<StockIn> vectorProduct = new Vector<StockIn>();
			        StockOutParser productParser = new StockOutParser();
